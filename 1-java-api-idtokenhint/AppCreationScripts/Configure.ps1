...
#> 
   ...
   $clientAppKey = $pw
   $clientAadApplication = New-AzureADApplication -DisplayName "Verifiable Credentials Java sample" `
                                                  -IdentifierUris "https://$tenantName/vcjavasample1" `
   ...
   Add-Content -Value "<tr><td>client</td><td>$currentAppId</td><td><a href='$clientPortalUrl'>VC Java sample</a></td></tr>" -Path createdApps.html
